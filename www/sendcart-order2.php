<?php
$to = 'tiendaonline@tiendaonline.uy'; /* your shop's email */
...
/* informacion agregada para que el que envia reciba una copia del pedido */
...
/* fin de informacion agregada */

Header('Location: http://shoppinguruguay.blogspot.com/p/pedido-enviado.html'); /* declaring the page to redirect if the mail is sent successfully */
?>